...
/**
 * Contains various lib functions to assist with String manipulation.
 *
 * @author King Lemming
 */
public final class StringHelper {
    ...
    private static final String LIGHT_GRAY = (char) 167 + "7";
    public static final String GRAY = (char) 167 + "8";
    public static final String LIGHT_BLUE = (char) 167 + "9";
    private static final String BRIGHT_GREEN = (char) 167 + "a";
    private static final String BRIGHT_BLUE = (char) 167 + "b";
    public static final String LIGHT_RED = (char) 167 + "c";
    private static final String PINK = (char) 167 + "d";
    private static final String YELLOW = (char) 167 + "e";
    private static final String WHITE = (char) 167 + "f";
    public static final String OBFUSCATED = (char) 167 + "k";
    public static final String BOLD = (char) 167 + "l";
    public static final String STRIKETHROUGH = (char) 167 + "m";
    public static final String UNDERLINE = (char) 167 + "n";
    private static final String ITALIC = (char) 167 + "o";
    private static final String END = (char) 167 + "r";
    private static final String shiftForInfo = LIGHT_GRAY + localize("message.cofh.holdShift1") + " " + YELLOW + ITALIC + localize("message.cofh.holdShift2") + " "
    ...
    private static String getScaledNumber(int number, int minDigits) {
