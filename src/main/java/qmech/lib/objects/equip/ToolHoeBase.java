...
public class ToolHoeBase extends ItemHoe {
    private final String suffix = "Hoe";

    public ToolHoeBase(ToolTypeBase toolType, CreativeTabBase ctab) {
        ...
        RecipeHelper.shapedRecipe(new ItemStack(this), ToolTypeBase.hoeCraftingShape, 'x', toolType.getCraftMaterial(), 's', Items.stick);
