...
public class ToolShovelBase extends ItemSpade {
    private final String suffix = "Shovel";

    public ToolShovelBase(ToolTypeBase toolType, CreativeTabBase ctab) {
        ...
        RecipeHelper.shapedRecipe(new ItemStack(this), ToolTypeBase.shovelCraftingShape, 'x', toolType.getCraftMaterial(), 's', Items.stick);
