...
public class ToolAxeBase extends ItemAxe {
    private final String suffix = "Axe";

    public ToolAxeBase(ToolTypeBase toolType, CreativeTabBase ctab) {
        ...
        RecipeHelper.shapedRecipe(new ItemStack(this), ToolTypeBase.axeCraftingShape, 'x', toolType.getCraftMaterial(), 's', Items.stick);
