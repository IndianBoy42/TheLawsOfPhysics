...
public class ToolSwordBase extends ItemSword {
    private final String suffix = "Sword";

    public ToolSwordBase(ToolTypeBase toolType, CreativeTabBase ctab) {
        ...
        RecipeHelper.shapedRecipe(new ItemStack(this), ToolTypeBase.swordCraftingShape, 'x', toolType.getCraftMaterial(), 's', Items.stick);
