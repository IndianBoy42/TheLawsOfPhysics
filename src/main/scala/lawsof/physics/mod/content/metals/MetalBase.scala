package lawsof.physics.mod.content.metals

import net.minecraft.block.material.Material
import lawsof.physics.lib.handler.WorldGenerator
import lawsof.physics.mod.init.{ModFluids, CTabs}
import lawsof.physics.lib.objects.fluid.FluidBase
import lawsof.physics.lib.objects.equip.types.{ToolTypeBase, ArmorTypeBase}
import net.minecraft.item.ItemStack
import lawsof.physics.lib.objects.info._
import lawsof.physics.lib.objects.item.ItemBase
import lawsof.physics.lib.objects.block.BlockBase
import net.minecraftforge.oredict.OreDictionary.registerOre
import lawsof.physics.lib.helper.Recipes._
