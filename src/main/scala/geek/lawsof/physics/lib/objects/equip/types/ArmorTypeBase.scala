package geek.lawsof.physics.lib.objects.equip.types

import net.minecraft.item.ItemStack
import net.minecraftforge.common.util.EnumHelper
import net.minecraft.item.ItemArmor.ArmorMaterial
import geek.lawsof.physics.lib.objects.info.ArmorInfo
import geek.lawsof.physics.lib.objects.equip.ArmorBase
